...
import com.google.accompanist.web.rememberSaveableWebViewNavigatorState
...
@Composable
private fun Home() {
    val webViewState = rememberSaveableWebViewNavigatorState()
    ...
    WebView(
        ...
        navigator = navigator,
        onDispose = { webView ->
            webViewBundleState.value = Bundle().apply { webView.saveState(this) }
        },
